...
public class SODao {
	...
	public void save(SODetail soDetail) {
		...
		query.setParameter(16, soDetail.getPractice());
		...
		query.setParameter(3, soDetail.getPractise());
		query.setParameter(4, soDetail.getPriority());
		query.setParameter(5, soDetail.getsoComments());
		//query.setParameter(7, soDetail.getSolastworkingDate());
		query.setParameter(6, soDetail.getLocation());
		query.setParameter(7, soDetail.getCity());
		query.setParameter(8, soDetail.getRims());
		query.setParameter(9, soDetail.getTracking());
		query.setParameter(10, soDetail.getSkills());
		//query.setParameter(13, soDetail.getSocreationDate());
		query.setParameter(11, soDetail.getFulfillmentPoc());
		query.setParameter(12, soDetail.getClientLob());
		query.setParameter(13, soDetail.getPractiseArea());
		query.setParameter(14, soDetail.getJobLevel());
		query.setParameter(15, soDetail.getProjectType());
		query.setParameter(16, soDetail.getProjectId());
		query.setParameter(17, soDetail.getDlMapping());
		query.setParameter(18, soDetail.getElMapping());
		query.setParameter(19, soDetail.getBillRate());*/
		query.executeUpdate();
		//em.getTransaction().commit();
		// TODO Auto-generated method stub
